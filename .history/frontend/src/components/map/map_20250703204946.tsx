...
const  InteractiveMap = () => {
  ...
  return (
    <div className="flex flex-col items-center gap-4 text-black">
        <h2 className="text-3xl sm:text-4xl md:text-5xl">Amenities in Fall R</h2>
        <p className="text-md sm:text-lg md:text-xl
        px-4 max-w-[1200px]">From scenic parks to cozy cafes, Fall river offers a rich blend of outdoor activities, dining spots, and community amenities to explore.</p>
