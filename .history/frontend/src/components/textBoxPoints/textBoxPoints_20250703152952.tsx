      ...
      >
        <section className="flex flex-col md:flex-row items-center justify-center pt-1 gap-6 px-4">
          ...
          >
            ...
            <p>
  Hello, I’m Nader — your <span class="font-bold">competitive edge</span> in the real estate market. From 
  <span class="font-bold">pricing strategies</span> to <span class="font-bold">negotiations</span> and 
  <span class="font-bold">complex paperwork</span>, I handle the hard parts so you can focus on your next chapter. 
  Whether you're buying or selling, I bring <span class="font-bold">clarity</span>, 
  <span class="font-bold">speed</span>, and <span class="font-bold">confidence</span> to every step — all while 
  ensuring you get the <span class="font-bold">best possible deal</span>. With deep 
  <span class="font-bold">local insight</span> and <span class="font-bold">multilingual communication</span> in 
  English, French, and Arabic, I help you reach more buyers and navigate every situation with ease.
  <br /><br />
  I’ve spent over <span class="font-bold">15 years</span> leading customer-facing teams, solving 
  <span class="font-bold">high-pressure problems</span>, and guiding people through 
  <span class="font-bold">life-changing decisions</span>. I’ve lived in Halifax since 2015, own 
  <span class="font-bold">rental properties</span> both here and overseas, and treat every client like family — 
