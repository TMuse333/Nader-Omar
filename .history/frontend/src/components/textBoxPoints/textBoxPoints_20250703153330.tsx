...
const aspects = [
  {
    ...
    description: "Over a decade helping buyers and sellers in the HRM area.",
  },
  {
    title: "Local Expertise",
    description: "Deep knowledge of Halifax, Lower Sackville, and surrounding areas.",
  },
  {
    title: "Proven Results",
    description: "All of my clients have gotten great deals on their real estate",
  },
];
