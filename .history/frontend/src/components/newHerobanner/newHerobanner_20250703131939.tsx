...
const NewHeroBanner = ({
  ...
  return (
    <header
      className={`w-full min-h-[80vh] md:min-h-screen relative flex items-center justify-center ${
        bgColor || 'bg-[#0e0e0e]'
      } overflow-hidden z-[3]`}
    >
        ...
        <div className="flex flex-col md:flex-row items-center justify-between">
          ...
          <div className="flex flex-col items-center md:items-start max-w-[600px] text-center md:text-left">
            ...
            <motion.h1
              ...
              className="text-3xl sm:text-4xl md:text-md text-red-200 font-bold text-white mb-4"
            >
              heell
            </motion.h1>
            ...
            {/* TypeAlongText */}
            <TypeAlongText
              styles="text-5xl sm:text-6xl md:text-xl font-semibold  mb-6"
              text={typeAlongText}
            ...
            {typeWriterExamples && (
              <h3 className="text-xl sm:text-2xl md:text-3xl font-semibold text-white mb-6 px-4 py-2 border border-[#00bfff]/50 rounded-xl">
            ...
            {/* Description */}
            <motion.p
              className="text-lg sm:text-xl md:text-lg text-white max-w-[500px]"
