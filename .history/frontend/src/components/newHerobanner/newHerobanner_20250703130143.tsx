...
import award from '../../../public/platinum-award.jpeg';
      ...
      <section className="w-full max-w-[1200px] mx-auto px-4 py-12 md:py-0 relative z-[2]">
        <div className="flex flex-col md:flex-row items-center justify-between">
          ...
          <div className="flex flex-col items-center md:items-start max-w-[600px] text-center md:text-left">
            ...
            {/* TypeAlongText */}
            <TypeAlongText
              styles="text-5xl sm:text-6xl md:text-7xl font-semibold  mb-6"
              text={typeAlongText}
            ...
            {/* Description */}
            <FadeInFromLeftText
              className="text-lg sm:text-xl md:text-2xl text-white max-w-[500px]"
