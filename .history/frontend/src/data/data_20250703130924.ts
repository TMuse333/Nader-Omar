...
import { TextAndListProps, CarouselGridProps, VerticalImageTextBoxProps } from 'focusflow-components';
export const heroData = {
  ...
  export const newHeroData: FullBodyHeroProps = {
    ...
    typeAlongKeywords: [
      ...
      'Wellington NS listings',
      'Multilingual real estate agent',
    ...
    typeWriterExamples: [
      ...
      'Quiet communities near Halifax',
      'Spacious family properties',
      'Investment-ready listings',
      'Move-in ready homes in Nova Scotia'
    ]
  };
